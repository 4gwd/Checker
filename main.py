...
import threading
stopuser = {}
token = '6648281010:AAEJmd7GkElXR62BVNVcPtNaDjwcUVWPx2g'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/Q_2_M")
			keyboard.add(contact_button)
			random_number = random.randint(32, 47)
			photo_url = f'https://t.me/Screen_for_bot/{random_number}'
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗝𝗢𝗜𝗡 ✨", url="https://t.me/W_2_8")
		keyboard.add(contact_button)
...
[↯] 𝗕𝗜𝗡 ↯ {cc[:6]}
[↯] 𝗕𝗮𝗻𝗸 ↯ {bank}
[↯] 𝗧𝗬𝗣𝗘 ↯ {card_type} - {brand}
[↯] 𝗖𝗼𝘂𝗻𝘁𝗿𝘆 ↯ {country} - [{country_flag}]
━━━━━━━━━━━━━━━━
[↯] 𝗧𝗶𝗺𝗲 𝗧𝗮𝗸𝗲𝗻 ⇾ {"{:.1f}".format(execution_time)} secounds
━━━━━━━━━━━━━━━━
[↯] 𝗕𝗼𝘁 𝗕𝘆 ⇾ <a href='tg://user?id=1839018065'>𝗧𝗔𝗞𝗘𝗠𝗜𝗖𝗛𝗜</a></b>'''
					msgC=f'''<b>𝗔𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝘾𝘾𝗡 ☑️
━━━━━━━━━━━━━━━━           
[↯] 𝗖𝗖 ⇾ <code>{cc}</code>
[↯] 𝗚𝗔𝗧𝗘𝗦: {gate} 🌩
[↯] 𝗥𝗘𝗦𝗣𝗢𝗡𝗦𝗘: {last}
...
def respond_to_vbv(message):
	def my_function():
		...
		try:
			...
			msg=f'''<b>𝗧𝗔𝗞𝗘𝗠𝗜𝗖𝗛𝗜 𝗩𝗜𝗣 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗕𝗘𝗗 ✅
...
def start(message):
	def my_function():
		...
		try:
			...
			pas ='TAKE-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))+'-'+'MICHI'
			current_time = datetime.now()
